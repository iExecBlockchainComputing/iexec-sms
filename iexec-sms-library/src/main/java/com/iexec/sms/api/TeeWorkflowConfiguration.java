...
/**
 * Configuration of tee workflow. It contains:
 * pre-compute image, pre-compute heap size, pre compute entrypoint,
 * post-compute image, post-compute heap size, post compute entrypoint.
 */
@Builder
@Getter
@AllArgsConstructor
