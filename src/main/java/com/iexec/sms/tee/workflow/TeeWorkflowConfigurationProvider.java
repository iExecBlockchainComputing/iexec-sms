...
@Configuration
@Validated
public class TeeWorkflowConfigurationProvider {

    @Getter
    public TeeWorkflowConfiguration configuration;

        void TeeWorkflowConfiguration(
        ...
        configuration = TeeWorkflowConfiguration.builder()
                .preComputeImage(preComputeImage)
                .preComputeFingerprint(preComputeFingerprint)
                .preComputeHeapSize(preComputeHeapSize)
                .postComputeImage(postComputeImage)
                .postComputeFingerprint(postComputeFingerprint)
    ...
    //         @NotBlank(message = "post-compute heap size must be provided")
    //         String postComputeHeapSize) {
    //     teeWorkflowConfiguration = TeeWorkflowConfiguration.builder()
    //             .preComputeImage(preComputeImage)
    //             .preComputeFingerprint(preComputeFingerprint)
    //             .preComputeHeapSize(preComputeHeapSize)
    //             .postComputeImage(postComputeImage)
